...
const NewsPage = () => {
  ...
  return <div className="container">
      ...
      <form className='search-form' onSubmit={handleSubmit}>
        <input placeholder='Search for new news' value={searchInput} onChange={event => setSearchInput(event.target.value)} />
        ...
        console.log(window.globalCount++);
        return <NewsCard article={article} key={article.objectID} />;
      })}
			</div>
